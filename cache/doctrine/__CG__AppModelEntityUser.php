 ...
 */
class User extends \App\Model\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'isActive', '' . "\0" . 'App\\Model\\Entity\\User' . "\0" . 'token', 'downloads');
        }
    ...
    public function hasValidToken($token)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasValidToken', array($token));

        return parent::hasValidToken($token);
    }
    ...
    public function generateNewToken($strength = 16)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'generateNewToken', array($strength));

        return parent::generateNewToken($strength);
    }
